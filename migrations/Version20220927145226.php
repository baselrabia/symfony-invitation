 ...
 */
final class Version20220927145226 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invitation (id INT AUTO_INCREMENT NOT NULL, 
            sender_id INT NOT NULL, 
            invited_id INT DEFAULT NULL, 
            title VARCHAR(255) NOT NULL, 
            content LONGTEXT NOT NULL, 
            sender_status VARCHAR(255) NOT NULL, 
            invited_status VARCHAR(255) DEFAULT NULL, 
            created_at DATETIME NOT NULL, 
            updated_at DATETIME NOT NULL, 
            INDEX IDX_F11D61A2F624B39D (sender_id), 
            INDEX IDX_F11D61A2C2ED4747 (invited_id), 
